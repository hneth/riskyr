...
hustosis <- riskyr(prev = .04, sens = .80, spec = (1 - .05), N = 1000)
...
## View parameters:
summary(s) # shows all scenario information
summary(s, summarize = "prob") # shows probabilities
summary(s, summarize = "freq") # shows frequencies
