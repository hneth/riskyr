## trans_prob_freq.R | riskyr
## 2018 01 26
## -----------------------------------------------
## Translate between probabilities and frequencies :
## -----------------------------------------------
...
## -----------------------------------------------
## (A) Translate 3 essential probabilities into 9 frequencies:
...
trans_prob <- function(prev = prob$prev,  # 3 essential probabilities (removed: mirt & fart ):
                       sens = prob$sens,  # using current probability info contained in prob!
                       spec = prob$spec,
                       N = freq$N,        # using current freq info contained in freq!
                       round = TRUE) {

  freq <- comp_freq(prev, sens, spec, N, round)  # use exiting function!
...
## -----------------------------------------------
## (B) Translate frequencies into probabilities:

## ToDo: Write trans_freq that uses
##       4 essential frequencies as input: hi mi fa cr
