...
## - Plot global riskyr object (freq and prob).
## - remove dependencies from library("diagram") in DESCRIPTION!

## Options available in PREVIOUS version:
## - by    ... "cd", "dc".
## - area  ... "no", "sq", "hr", "vr".
...
## plot_tree2: Plot a tree diagram of natural frequencies ----------

## plot_tree2: Documentation --------
...
#'
#' \code{plot_tree2} draws a tree diagram of
...
#'
#' \code{plot_tree2} removes the dependency of the earlier version
#' \code{\link{plot_tree}} on the R package "diagram"
...
#' plot_tree2(by = "dc")
#' plot_tree2(area = "sq")
#' plot_tree2(p.lbl = "num")
#' plot_tree2(title.lbl = "")
#' plot_tree2(N = 33)
#' plot_tree2(N = NA)
#'
#' # Computing and plotting new frequencies:
#' plot_tree2(prev = 1/3)
#' plot_tree2(prev = 1/3, N = 55)
#' plot_tree2(prev = 1/3, N = NA)
#' plot_tree2(prev = 1/3, round = FALSE)
#' plot_tree2(prev = .10, sens = .90, spec = 1/3, N = 100)
#' plot_tree2(prev = .10, sens = .90, spec = NA, fart = 1/3, N = 33)
#' plot_tree2(prev = .10, sens = .90, spec = 1/3, fart = NA, N = NA)
#' plot_tree2(prev = .10, sens = .90, spec = NA, fart = 1/3, N = NA)
#'
#' # Area options:
#' plot_tree2(area = "sq")
#' plot_tree2(area = "sq", round = FALSE)
#' plot_tree2(area = "hr")
#' plot_tree2(area = "vr", round = FALSE)
#'
#' # Accuracy:
#' plot_tree2(show.accu = TRUE)               # => default w = .5 (balanced accuracy "bacc")
#' plot_tree2(show.accu = TRUE, w.acc = 1/3)  # => (weighted accuracy "wacc")
#' plot_tree2(show.accu = FALSE)              # => no accuracy info.
#'
#' # Perspectives, areas, and label options:
#' plot_tree2(by = "cd", area = "sq", p.lbl = "nam")  # => by cond + sq + prob names
#' plot_tree2(by = "cd", area = "hr", p.lbl = "num")  # => by cond + hr + prob numbers
#' plot_tree2(by = "dc", area = "sq", p.lbl = "num")  # => by dec  + sq + names and numbers
#' plot_tree2(by = "dc", area = "vr", p.lbl = "mix")  # => by dec  + vr + min. labels
#'
#' # Custom colors and shadows:
#' plot_tree2(prev = .08, sens = .92, spec = .95, N = 10000, area = "hr")
#' plot_tree2(area = "sq", col.boxes = "gold", col.border = "steelblue4",
#'           col.shadow = "steelblue4", cex.shadow = .008)
#' plot_tree2(N = NA, area = "vr", col.txt = "steelblue4", col.boxes = "lightyellow",
...
## plot_tree2: Definition --------

plot_tree2 <- function(prev = num$prev,             # probabilities
...
# plot_tree2(title.lbl = "")
# plot_tree2(N = 33)
# plot_tree2(N = NA)              # => compute suitable population size (+ warning)
# plot_tree2(prev = 1/3, p.lbl = "num")
# plot_tree2(prev = 1/3, N = 55)
# plot_tree2(prev = 1/3, N = NA)  # => compute suitable population size (+ warning)
# plot_tree2(prev = 1/3, round = FALSE)
# plot_tree2(prev = .10, sens = .90, spec = 1/3, N = 100)
# plot_tree2(prev = .10, sens = .90, spec = NA, fart = 1/3, N = 33)
# plot_tree2(prev = .10, sens = .90, spec = 1/3, fart = NA, N = NA)
...
# plot_tree2(area = "sq", col.boxes = "gold", col.border = "steelblue4",
#           col.shadow = "steelblue4", cex.shadow = .008)
# plot_tree2(N = NA, area = "vr", col.txt = "steelblue4", col.boxes = "lightyellow", col.border = grey(.3, .7),
