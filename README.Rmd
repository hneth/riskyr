...
(see [Neth et al., 2021](https://doi.org/10.3389/fpsyg.2020.567817), for details).
...
The current version (0.5.0, as of Sep 15, 2025) is under active development. 
Its primary designers are 
[Hansjörg Neth](https://spds.uni-konstanz.de/hans-neth), 
[Felix Gaisbauer](https://spds.uni-konstanz.de/people), 
[Nico Gradwohl](https://spds.uni-konstanz.de/people), and 
[Wolfgang Gaissmaier](https://spds.uni-konstanz.de/people), who are researchers at the department of 
[Social Psychology and Decision Sciences](https://spds.uni-konstanz.de/) at the 
...
[GPL 2](https://www.tldrlegal.com/license/gnu-general-public-license-v2) | 
...
Calling `citation("riskyr")` in the package also provides this information.
