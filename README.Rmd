...
```{r hustosis_tree, eval = TRUE, fig.width = 7.2, fig.height = 5.8}
## View graphics: 
...
```{r hustosis_icons, eval = TRUE, fig.width = 7.2, fig.height = 4.2}
plot(hustosis, plot.type = "icons")   # plot an icon array: 
```

#### Mosaic plot 

```{r hustosis_mosaic, eval = TRUE, fig.width = 4.5, fig.height = 4.5}
plot(hustosis, plot.type = "mosaic")  # plot a mosaic plot: 
```

#### Curves

```{r hustosis_curve, eval = TRUE, fig.width = 7.2, fig.height = 5}
plot(hustosis, plot.type = "curve")   # plot curves (as a function of prevalence):
```

#### Planes 

```{r hustosis_plane, eval = TRUE, fig.width = 5, fig.height = 4.5}
...
```{r scen21_fnet, eval = TRUE, fig.width = 7.2, fig.height = 6.5}
