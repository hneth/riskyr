...
```{r ex1_prism, eval = TRUE, fig.width = 7.2, fig.height = 5.5, fig.show = 'hold'}
...
```{r ex1_tree, eval = TRUE, fig.width = 7.2, fig.height = 4.2}
...
```{r ex1_icons, eval = TRUE, fig.width = 7.2, fig.height = 4.2}
...
```{r ex1_area, eval = TRUE, fig.width = 7.2, fig.height = 5}
...
```{r ex1_tab, eval = TRUE, fig.width = 7.2, fig.height = 5}
...
```{r ex1_bar, eval = TRUE, fig.width = 7.2, fig.height = 5}
...
```{r ex1_curve, eval = TRUE, fig.width = 7.2, fig.height = 5}
...
```{r ex1_plane, eval = TRUE, fig.width = 6, fig.height = 4.5}
...
```{r ex2_tree, eval = TRUE, fig.width = 7.2, fig.height = 5}
...
```{r ex2_prism_hr, eval = TRUE, fig.width = 7.2, fig.height = 5}
