...
- An **interactive online version** is available at [http://riskyr.org/](`r url_riskyr_org`). 
...
The current version (0.3.0, as of Mar. 23, 2021) is under active development. 
...
[Wolfgang Gaissmaier](https://www.spds.uni-konstanz.de/wolfgang-gaissmaier), who are researchers at the department of 
