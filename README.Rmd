...
<img src = "./inst/pix/riskyr_cube.png" alt = "riskyr" style = "width: 160px; float: right; border:20;"/>
</a>
...
2. It would be desirable to have a set of (computational and representational) tools that allow various 
calculations, translations between formats, and many alternative views on the interplay between probabilities and frequencies. 
