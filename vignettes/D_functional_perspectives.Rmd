...
```{r plot_curve_1, fig.width = 7.0, fig.height = 5, fig.show = 'asis', fig.cap = "Showing PPV and NPV as a function of prevalence (for a prevalance of 1% and given values of sensitivity and specificity) in the original mammography screening scenario."}
