...
```{r plot_icons_1, warning = FALSE, fig.width = 7.2, fig.height = 6, fig.show = 'asis', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
...
```{r plot_icons_mosaic, warning = FALSE, fig.width = 6, fig.height = 6, fig.show = 'asis', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
plot_icons(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000,
           type = "mosaic",
           title.lbl = "Mammography screening")
```
...
| Nr.  | Vignette | Content    |        
| ---: |:---------|:-----------|
| 1. | [User guide](01_user_guide.html) | Motivation and general instructions | 
| 2. | [Data formats](02_data_formats.html) | Data formats: Frequencies and probabilities | 
| 3. | [Confusion matrix](03_confusion_matrix.html) | Confusion matrix and accuracy metrics |
