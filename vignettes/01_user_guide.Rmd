...
```{r plot_icons_1, warning = FALSE, fig.width = 7.2, fig.height = 4.4, fig.show = 'asis', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
...
```{r plot_icons_mosaic, warning = FALSE, fig.width = 7.2, fig.height = 6, fig.show = 'asis', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
