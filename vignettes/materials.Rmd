...
```{r plot_curve, fig.width = 7.2, fig.height = 5, fig.show = 'asis', fig.cap = "Curves that show PPV and NPV as a function of prevalence (for given values of sensitivity and specificity)."}
library("riskyr")  # load the "riskyr" package
...
```{r plot_plane, fig.width = 6, fig.height = 5, fig.show = 'asis', fig.cap = "Planes that show PPV, NPV, the proportion of positive predictions (ppod) and overall accuracy (acc) as a function of sensitivity and specificity (for given prevalence)."}
