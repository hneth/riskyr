...
Condensed to its core, the confusion matrix classifies each individual case into one of 4 possible categories that result from combining two binary variables (i.e., the condition and decision of each case) with each other. This may still sound complicated, but looks like this:
