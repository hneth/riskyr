---
title: "Confusion matrix and accuracy metrics"
...
Fortunately, this table is not so confusing any more: 
It shows four frequency counts (or "joint" frequencies) that result from cross-tabulating two binary dimensions. 
