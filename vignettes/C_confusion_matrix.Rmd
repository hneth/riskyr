...
For details on the theoretical background, see the following article: 
...
An third perspective is provided by considering the diagonals of the 2x2 matrix:

(c)\ by accuracy\ (`ac`) (denotes the correspondence between the condition and decision, see below). 
