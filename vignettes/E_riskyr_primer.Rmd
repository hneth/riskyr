...
```{r plot_area_sq, eval = FALSE, fig.width = 7, fig.height = 5.5}
...
```{r s10_icons, eval = FALSE, fig.width = 7.2, fig.height = 4.5}
...
```{r s10_prism_1, fig.width = 7.2, fig.height = 5.5}
plot(s10, 
...
```{r s10_curve, eval = FALSE, fig.width = 7.2, fig.height = 6.2}
plot(s10, type = "curve", 
...
```{r s10_planes, results = "hold", fig.width = 7.9, fig.height = 4.2}
...
Importantly, the properties of the test are identical for both scenarios -- only the population (i.e., its prevalance for the condition) has changed. 
