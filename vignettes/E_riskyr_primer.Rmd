---
title: "Quick start primer on using riskyr"
author: "Hansjörg Neth & Nico Gradwohl, SPDS, uni.kn"
date: "`r Sys.Date()`"
output: 
...
```{r plot-default, include = TRUE, fig.align = "center", fig.width = 6, fig.height = 5, fig.alt = "Example of a plot showing a default riskyr scenario"}
plot(my_scenario)
```
...
```{r plot-area-sq, eval = FALSE, fig.align = "center", fig.width = 6, fig.height = 5, fig.alt = "Illustrating riskyr plotting options"}
...
```{r icons, fig.align = "center", fig.width = 5.5, fig.height = 3.5, fig.alt = "An icon array of a riskyr scenario."}
...
```{r tree-plot, fig.align = "center", fig.width = 6, fig.height = 3.5, fig.alt = "A tree diagram of a riskyr scenario."}
...
```{r plotting-curve, fig.align = "center", fig.width = 5.5, fig.height = 4.5, fig.alt = "A curve showing PPV and NPV as a function of prev"}
...
```{r s10-icons, eval = FALSE, fig.width = 7.2, fig.height = 4.5, fig.alt = "Examples of riskyr plots"}
...
```{r s10-prism-1, fig.align = "center", fig.width = 6, fig.height = 4.5, fig.alt = "Example of a riskyr prism plot with freq scaled as horizontal bars"}
plot(s10, 
...
```{r s10-planes, fig.align = "center", fig.show = "hold", fig.width = 3.5, fig.height = 3, fig.alt = "More riskyr plots"}
