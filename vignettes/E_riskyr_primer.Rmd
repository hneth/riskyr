...
```{r plot-default, include = TRUE, fig.align = "center", fig.width = 7.2, fig.height = 6.0}
plot(my_scenario)
```
...
```{r plot-area-sq, eval = FALSE, fig.align = "center", fig.width = 7.0, fig.height = 5.8}
...
```{r icons, fig.align = "center", fig.width = 7.0, fig.height = 4.2}
...
```{r tree, fig.align = "center", fig.width = 7.2, fig.height = 4.5}
...
```{r plotting-curve, fig.align = "center", fig.width = 7.0, fig.height = 5.0}
...
```{r s10-prism-1, fig.align = "center", fig.width = 7.2, fig.height = 5.2}
plot(s10, 
...
```{r s10-curve, eval = FALSE, fig.align = "center", fig.width = 7.2, fig.height = 6.0}
plot(s10, type = "curve", 
...
```{r s10-planes, fig.align = "center", fig.show = "hold", fig.width = 5.2, fig.height = 3.5}
...
(see [Neth et al., 2021](https://doi.org/10.3389/fpsyg.2020.567817), for its theoretical background). 
