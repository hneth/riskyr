...
* `popu.lbl` specifies the population of interest (e.g., "prisoners").


* `cond.true.lbl` specifies a label for if the condition is true; in this case "reoffends".
* `cond.false.lbl` specifies a label for if the condition is false; in this case "does not reoffend". 
