...
```{r plot_default, include = TRUE, fig.width = 7, fig.height = 6}
plot(my_scenario)
```
...
```{r plot_area_sq, eval = FALSE, fig.width = 7, fig.height = 5.8}
...
```{r icons, fig.width = 7.2, fig.height = 5}
...
```{r plotting_curve, fig.width = 7, fig.height = 5.4}
...
```{r s10_prism_1, fig.align = "center", fig.width = 7.0, fig.height = 5.6}
plot(s10, 
...
```{r s10_curve, eval = FALSE, fig.align = "center", fig.width = 7.0, fig.height = 6.0}
plot(s10, type = "curve", 
...
```{r s10_planes, fig.align = "center", fig.show = "hold", fig.width = 5.5, fig.height = 3.8}
