...
(a) by condition\ (`cd`) (corresponding to the two columns of the [confusion matrix](confusion_matrix.html)): 
...
(b) by decision\ (`dc`) (corresponding to the two rows of the [confusion matrix](confusion_matrix.html)): 
...
(c) by accuracy\ (`ac`) (or the correspondence of decisions to conditions, corresponding to the two diagonals of the [confusion matrix](confusion_matrix.html)): 
