...
1. by condition: conditional probabilities (2. to 5.) depend on the _condition_'s `prev` and features of the _decision_.  
2. by decision: conditional probabilities (7. to 10.) depend on the _decision_'s `ppod` and features of the _condition_.  
3. by accuracy: conditional probabilities based on _accuracy_ `acc` are currently not computed or defined.   
