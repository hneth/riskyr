...
```{r riskyr_scenario_plot, fig.width = 7.2, fig.height = 7.2}
...
Similarly, the population area of the mosaic plot can first be split by decisions (i.e., horizontally) by specifying the option `by = "dc"`:
