...
The following sections focus on the practical aspects of using **riskyr**. 
...
or --- when using $C$ to denote cancer and $T$ a positive test:
...
```{r riskyr_scenario_plot, fig.width = 7.2, fig.height = 6.4}
...
```{r plot_icons_1, warning = FALSE, fig.width = 7.2, fig.height = 4.5, fig.show = 'hold', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
...
```{r plot_tree_cd, fig.width = 7, fig.height = 5, fig.show = 'hold', fig.cap = "A tree diagram that applies the provided probabilities and frequencies to a population of 1000 individuals."}
...
```{r plot_mosaic_cd, eval = TRUE, fig.align = "center", fig.width = 7, fig.height = 6, fig.show = 'hold', fig.cap = "An area plot in which area sizes represent the probabilities/relative frequencies of subgroups."}
...
```{r plot_bar, eval = FALSE, fig.width = 7, fig.height = 5.6, fig.show = 'hold', fig.cap = "A bar plot."}
...
```{r plot_fnet, fig.width = 7, fig.height = 6.4, fig.show = 'hold', fig.cap = "A prism plot that integrates 2 tree diagrams and represents relative frequency by area size."}
plot_prism(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000, 
...
```{r plot_tree_dc, eval = FALSE, fig.width = 7, fig.height = 5, fig.show = 'hold', fig.cap = "Alternative tree diagram that splits the population by decision."}
plot_prism(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000, 
...
```{r plot_tree_ac, eval = FALSE, fig.width = 7, fig.height = 5, fig.show = 'hold', fig.cap = "Alternative tree diagram that splits the population by accuracy"}
plot_prism(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000, 
...
```{r plot_mosaic_dc, eval = FALSE, fig.align = "center", fig.width = 7, fig.height = 5, fig.show = 'hold', fig.cap = "Alternative mosaic plot that first splits the population (horizontally) by decision."}
plot_area(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000,
