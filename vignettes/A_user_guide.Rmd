...
```{r plot_mosaic_cd, fig.align = "center", fig.width = 5, fig.height = 5, fig.show = 'asis', fig.cap = "A mosaic plot in which area sizes represent the relative frequencies of subgroups."}
...
```{r plot_mosaic_dc, fig.align = "center", fig.width = 5, fig.height = 5, fig.show = 'asis', fig.cap = "Alternative mosaic plot that first splits the population (horizontally) by decision."}
plot_area(prev = .01, sens = .80, spec =   NA, fart = .096, N = 1000,
...
```{r plot_tree_dc_vr, fig.width = 7, fig.height = 4, fig.show = 'asis', fig.cap = "A prism diagram that represents relative frequencies as the width of horizontal rectangles."}
plot_prism(prev = .01, sens = .80, spec =   NA, fart = .096, N = 1000, 
           by = "dc", area = "hr", 
           title_lbl = "Mammography screening")
```
...
```{r plot_icons_mosaic, warning = FALSE, fig.width = 6, fig.height = 5, fig.show = 'asis', fig.cap = "An icon array showing the mammography scenario for a population of 1000 individuals."}
plot_icons(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000, 
