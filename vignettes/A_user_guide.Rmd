...
```{r plot_mosaic_cd, eval = TRUE, fig.align = "center", fig.width = 7, fig.height = 6, fig.show = 'asis', fig.cap = "An area plot in which area sizes represent the probabilities/relative frequencies of subgroups."}
...
```{r plot_bar, eval = FALSE, fig.width = 7, fig.height = 5.6, fig.show = 'asis', fig.cap = "A bar plot."}
...
```{r plot_fnet, fig.width = 7, fig.height = 6.4, fig.show = 'asis', fig.cap = "A prism plot that integrates 2 tree diagrams and represents relative frequency by area size."}
plot_prism(prev = .01, sens = .80, spec = NA, fart = .096, N = 1000, 
