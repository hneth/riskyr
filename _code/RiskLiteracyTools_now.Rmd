...
=======
  chunk_output_type: console
>>>>>>> 71b6979c033353d6a2e65b11dac7970c73ddd106
---
...
1. Define some vectors of length `N` based on the above variables:
...
(sum(population$sdt == "hi") + sum(population$sdt == "cr"))/N
```

3. Visualize the population:
