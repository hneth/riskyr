...
Provide some useful visualizations of risk information as interactive tools (in R and Shiny).

## Initial Set of Tools

Based on a set of common parameters: N, prevalence, sensitivity, specificity (or false alarm rate).

1. Icon array

2. Diagnostic measures based on natural frequencies: 
