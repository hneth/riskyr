...
setwd("~/Desktop/stuff/Dropbox/_txt/_Konstanz/_research/_RiskLiteracyTools/") # set to current directory
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# (A) unikn.col palette (as RGB, without transparency): 
...
```{r, graphical_settings, eval = TRUE, echo = FALSE}
# (1) Packages: 
library(ggplot2)
library(cowplot)
...
prev <- 0.01 # prevalence in population = p(true positive)
sens <- .90 # sensitivity = p(positive decision | true positive)
spec <- .91 # specificity = p(negative decision | true negative)
