...
## (3) As a function:
## (a) PPV only:
plot.PV.plane <- function(prev, sens.range, spec.range, metric = "PPV") {
...
## Check: 
plot.PV.plane(prev, sens.range, spec.range, metric = "PPV")

## (b) Both in 1 plot:
plot.PV.planes <- function(prev, sens.range, spec.range) {
...
# Check: 
plot.PV.planes(prev, sens.range, spec.range)
```
